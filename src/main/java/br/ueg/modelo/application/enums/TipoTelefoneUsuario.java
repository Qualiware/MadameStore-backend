 ...
 * @author UEG
 */
public enum TipoTelefoneUsuario {
	 ...
	 * @param descricao
	 */
	TipoTelefoneUsuario(final Long id, final String descricao) {
		this.id = id;
	...
	/**
	 * Retorna a instância de {@link TipoTelefoneUsuario} conforme o 'id' informado.
	 * 
	 * @param id
	 * @return
	 */
	public static TipoTelefoneUsuario getById(final Long id) {
